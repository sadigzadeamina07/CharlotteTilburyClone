  ...
  return (
    <div className="relative px-[1rem] py-[2rem]">
      <div className="text-center mb-[1rem]">
        ...
        <p>
          Discover the beauty secrets the whole world has fallen in love with!
        </p>
      </div>
      ...
      <button
        ...
        onClick={scrollLeft}
        className="hidden md:block absolute left-1 lg:left-auto lg:right-14 top-[7.5%] -translate-y-1/2 shadow-2xl z-10 disabled:opacity-30 disabled:cursor-not-allowed bg-white/80 lg:bg-transparent rounded-full p-1 lg:p-0      cursor-pointer"
      >
      ...
      <button
        ...
        onClick={scrollRight}
        className="hidden md:block absolute right-1 lg:right-2 top-[7.5%] -translate-y-1/2 shadow-2xl z-10 disabled:opacity-30 disabled:cursor-not-allowed bg-white/80 lg:bg-transparent rounded-full p-1 lg:p-0      cursor-pointer"
      >
