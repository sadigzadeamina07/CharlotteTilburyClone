                        ...
                        <div className="hidden lg:block mt-[60px] relative">
                          ...
                          {desktopCountryOpen && (
                            <div className="absolute top-[calc(100%+15px)] left-0 bg-white shadow-[0_4px_20px_rgba(0,0,0,0.15)] p-5 w-[320px] z-[100] border border-[#eae6e6]">
                              <div className="absolute -top-2 left-8 w-4 h-4 bg-white border-t border-l border-[#eae6e6] transform rotate-45 shadow-[2px_2px_5px_rgba(0,0,0,0.05)]" />
                              <div className="mb-4 relative z-10">
                                <label className="block text-[13px] font-sans text-[#333333] mb-2 font-medium">
                                  Shipping to*
                                </label>
                              ...
                              <button
                                ...
                                className={`w-full transition-colors text-white font-bold uppercase text-[14px] py-3 tracking-wider relative z-10 rounded-none ${
                                  tempDesktopCountryName ? 'bg-[#333333] hover:bg-black cursor-pointer' : 'bg-[#d3d3d3] cursor-not-allowed'
                                }`}
                              >
                                CONTINUE
                              </button>
